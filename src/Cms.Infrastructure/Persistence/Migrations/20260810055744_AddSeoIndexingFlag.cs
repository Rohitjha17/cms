...
{
    /// <inheritdoc />
    public partial class AddSeoIndexingFlag : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeVariant = table.Column<int>(type: "int", nullable: false),
                    ...
                    HeaderImageUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    FooterText = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Phone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    MapEmbedUrl = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomePageSections_SiteId",
                table: "HomePageSections",
                column: "SiteId");

            migrationBuilder.CreateIndex(
                name: "IX_HomePageSections_TenantId_SiteId_DisplayOrder",
                table: "HomePageSections",
                columns: new[] { "TenantId", "SiteId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_HomePageSections_TenantId_SiteId_SectionKey",
                table: "HomePageSections",
                columns: new[] { "TenantId", "SiteId", "SectionKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MediaFiles_SiteId",
                table: "MediaFiles",
                column: "SiteId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaFiles_TenantId_SiteId_StorageKey",
                table: "MediaFiles",
                columns: new[] { "TenantId", "SiteId", "StorageKey" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pages_TenantId_SiteId_Slug",
                table: "Pages",
                columns: new[] { "TenantId", "SiteId", "Slug" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeoSettings_TenantId_SiteId",
                table: "SeoSettings",
                columns: new[] { "TenantId", "SiteId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sites_TenantId_SiteKey",
                table: "Sites",
