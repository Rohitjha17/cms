...
public static class HomePageSeed
{
    ...
    private static string? DefaultJson(string key) => key switch
    {
        ...
        HomePageSectionKeys.Gallery => """{"items":[{"title":"Learning beyond classrooms","imageUrl":"https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=900&q=80","alt":"Students on campus"},{"title":"Spaces that inspire","imageUrl":"https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&w=900&q=80","alt":"University building"},{"title":"A vibrant community","imageUrl":"https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&w=900&q=80","alt":"Teacher working with students"}]}""",
