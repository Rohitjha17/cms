...
public sealed class SchoolContentService : ISchoolContentService
{
    ...
    public async Task<SiteSettingsDto> GetSettingsAsync(CancellationToken cancellationToken)
    {
        ...
        return new SiteSettingsDto
        {
            ...
            NoticeLabel = String(json, "noticeLabel"),
            HeaderContact = Boolean(json, "headerContact"),
            HeaderCtaText = String(json, "headerCtaText"),
            HeaderCtaLink = String(json, "headerCtaLink"),
            HeroPlainImages = Boolean(json, "heroPlainImages"),
            LogoShape = String(json, "logoShape"),
            PageTitleSize = String(json, "pageTitleSize"),
            PageTitleAlign = String(json, "pageTitleAlign"),
            ...
            NoticeBarStyle = String(json, "noticeBarStyle"),
            ...
            SectionAnimation = String(json, "sectionAnimation"),
            SectionPattern = String(json, "sectionPattern"),
            HeroSlideSeconds = Number(json, "heroSlideSeconds") ?? 0,
            HeroShowControls = Boolean(json, "heroShowControls", true),
    ...
    public async Task<SiteSettingsDto> SaveSettingsAsync(SiteSettingsDto dto, CancellationToken cancellationToken)
    {
        ...
        var json = new JsonObject
        {
            ...
            ["noticeLabel"] = Clean(dto.NoticeLabel),
            ["headerContact"] = dto.HeaderContact,
            ["headerCtaText"] = Clean(dto.HeaderCtaText),
            ["headerCtaLink"] = Clean(dto.HeaderCtaLink),
            ["heroPlainImages"] = dto.HeroPlainImages,
            ["logoShape"] = Clean(dto.LogoShape),
            ["pageTitleSize"] = Clean(dto.PageTitleSize),
            ["pageTitleAlign"] = Clean(dto.PageTitleAlign),
            ["logoHeight"] = dto.LogoHeight,
            ["scrollAnimations"] = dto.ScrollAnimations,
            ["noticeBarColor"] = Clean(dto.NoticeBarColor),
            ["noticeBarStyle"] = Clean(dto.NoticeBarStyle),
            ["buttonColor"] = Clean(dto.ButtonColor),
            ...
            ["imageHover"] = Clean(dto.ImageHover),
            ["linkHover"] = Clean(dto.LinkHover),
            ["hoverColor"] = Clean(dto.HoverColor),
            ["sectionAnimation"] = Clean(dto.SectionAnimation),
            ["sectionPattern"] = Clean(dto.SectionPattern),
            ["heroSlideSeconds"] = dto.HeroSlideSeconds,
            ["heroShowControls"] = dto.HeroShowControls,
